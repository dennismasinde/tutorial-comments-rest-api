package io.maddennis.tutorialcomments.controllers;

import io.maddennis.tutorialcomments.entities.Comment;
import io.maddennis.tutorialcomments.exceptions.ResourceNotFoundException;
import io.maddennis.tutorialcomments.repositories.CommentRepository;
import io.maddennis.tutorialcomments.repositories.TutorialRepository;
...
public class CommentController {
    ...
    @PostMapping(path = "/tutorials/{tutorialId}/comments", produces = "application/json")
    ...
    @PutMapping(path = "/comments/{id}", produces = "application/json")
    ...
    @DeleteMapping(path = "/tutorials/{tutorialId}/comments", produces = "application/json")
